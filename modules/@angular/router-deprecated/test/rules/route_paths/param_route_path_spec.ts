...
import {ParamRoutePath} from '@angular/router-deprecated/src/rules/route_paths/param_route_path';
import {parser, Url} from '@angular/router-deprecated/src/url_parser';
