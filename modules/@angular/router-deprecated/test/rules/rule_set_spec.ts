...
import {describe, it, iit, ddescribe, inject, beforeEach,} from '@angular/core/testing/testing_internal';
import {expect} from '@angular/platform-browser/testing/matchers';
import {AsyncTestCompleter} from '@angular/core/testing/testing_internal';
import {RouteMatch, PathMatch, RedirectMatch} from '@angular/router-deprecated/src/rules/rules';
import {RuleSet} from '@angular/router-deprecated/src/rules/rule_set';
import {GeneratedUrl} from '@angular/router-deprecated/src/rules/route_paths/route_path';
import {Route, Redirect} from '@angular/router-deprecated/src/route_config/route_config_decorator';
import {parser} from '@angular/router-deprecated/src/url_parser';
