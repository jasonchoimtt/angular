...
import {RouterOutlet} from '@angular/router-deprecated/src/directives/router_outlet';
import {ObservableWrapper, PromiseWrapper} from '../src/facade/async';
import {ListWrapper} from '../src/facade/collection';
import {Type} from '../src/facade/lang';
import {AsyncRoute, Redirect, Route, RouteConfig} from '@angular/router-deprecated/src/route_config/route_config_decorator';
import {ROUTER_PRIMARY_COMPONENT, RouteRegistry} from '@angular/router-deprecated/src/route_registry';
import {RootRouter, Router} from '@angular/router-deprecated/src/router';
