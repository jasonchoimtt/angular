...
import {JSONPConnection, JSONPConnection_, JSONPBackend, JSONPBackend_} from '@angular/http/src/backends/jsonp_backend';
...
import {RequestOptions, BaseRequestOptions} from '@angular/http/src/base_request_options';
import {BaseResponseOptions, ResponseOptions} from '@angular/http/src/base_response_options';
import {ResponseType, ReadyState, RequestMethod} from '@angular/http/src/enums';
