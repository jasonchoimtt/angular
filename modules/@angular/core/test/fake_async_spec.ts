...
import {TimerWrapper, PromiseWrapper} from '@angular/router-deprecated/src/facade/async';
import {BaseException} from '@angular/router-deprecated/src/facade/exceptions';
