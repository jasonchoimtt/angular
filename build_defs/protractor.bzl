...
protractor_test = rule(
    ...
    attrs = {
        ...
        "_protractor": attr.label(default=Label("//:protractor"), executable=True),
        "_serve_runfiles": attr.label(
            default = Label("//:serve_runfiles"),
            executable = True,
        ),
        "_launcher_template": attr.label(
            default = Label("//build_defs:protractor_launcher_template"),
            allow_files = True,
            single_file = True,
        ),
    },
